        ...
        success: function (data) {
            ...
            if (data['error'] != 0) {
                entry = '<div class="card  bg-danger text-white mb-3" style="max-width: 36rem;">\n' +
                    ...
                    ' it is not a valid kernel module. Deleted from server<br><br>' +
                    data['stdout'] + '</small>\n' +
                    '  </div>\n' +
                    '</div><br>';
                ...
                entry = '<div class="card  bg-secondary text-white mb-3" style="max-width: 36rem;">\n' +
                    ...
                    '</div><br>';
                $("#loadead-modules").append(entry);
                $('#' + strIDrand).click(install_module);
            }
        }
    });
}

function install_module(e) {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data['error'] == 0) {
                ...
                $(e.target).html('Module installed successfully');
